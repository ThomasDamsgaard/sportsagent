        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex items-center mb-8">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="simple-search" class="block w-full rounded-md pl-10 border-gray-200 shadow focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Search Teams" required>
                </div>
