<footer class="mb-8 mt-32">
    <div class="mx-auto max-w-7xl px-6 text-center lg:px-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-600 sm:text-center">© {{ Carbon\Carbon::now()->year }} <a href="https://onlinesportstalents.com" class="hover:underline">OnlineSportsTalents</a>. All Rights Reserved.
            </span>
            <div class="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
                <a target="_blank" href="https://www.facebook.com/profile.php?id=100094420561124" class="text-gray-600 hover:text-gray-900 dark:hover:text-white">
                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                    </svg>
                </a>
                <a target="_blank" href="https://www.instagram.com/onlinesportstalents" class="text-gray-600 hover:text-gray-900 dark:hover:text-white">
                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a target="_blank" href="https://www.x.com/onsportstalents" class="text-gray-600 hover:text-gray-900 dark:hover:text-white">
                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        {{-- <span class="text-sm text-gray-600 sm:text-center dark:text-gray-400">© 2021-2022 <a href="#" class="hover:underline">Flowbite™</a>. All Rights Reserved.</span> --}}
    </div>
</footer>
