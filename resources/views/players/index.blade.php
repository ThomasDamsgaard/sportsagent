            ...
            <form action="{{ route('players.search.index') }}">
                <div class="flex items-center">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" id="search" name="search" class="block w-full rounded-md pl-10 border-gray-200 shadow focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Search Players By Name" required>
                    </div>
                        ...
                        <div class="space-y-4 col-span-1">
                            <div class="relative flex gap-x-3">
                              <div class="flex h-6 items-center">
                                <input onchange="this.form.submit()" id="verified" name="verified" value="verified" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" {{ request()->has('verified' ) ? 'checked' : '' }}>
                              </div>
