            ...
            <div class="sm:grid sm:grid-cols-3 sm:gap-4">
                <div class="sm:col-span-1">
                    <div class="overflow-hidden bg-white shadow sm:rounded-lg sm:col-span-2">
                        <div class="flex flex-col px-4 py-5 sm:px-6 space-y-4">
                            <img class="h-24 w-24 rounded-full ring-2 ring-gray-200" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=256&h=256&q=80" alt="">
                            <div>
                                <h3 class="text-lg font-medium leading-6 text-gray-900">{{ $player->name }}</h3>
                            </div>
                            <div class="flex items-center">
                                @svg('heroicon-s-briefcase', 'h-5 w-5 flex-shrink-0 text-gray-400')
                                <p class="text-gray-900 ml-2">
                                    Fitness Coach
                                </p>
                            </div>
                            <div class="flex items-center">
                                @svg('heroicon-s-map-pin', 'h-5 w-5 flex-shrink-0 text-gray-400')
                                <p class="text-gray-900 ml-2">
                    ...
                    <div class="border-t border-gray-200">
                        <dl>
                            ...
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{{ $player->positions }}</dd>
                            </div>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="sm:grid sm:grid-cols-3 sm:gap-4">
                ...
                <div class="overflow-hidden bg-white shadow sm:col-span-full sm:rounded-lg">
                    ...
                    <div class="border-t border-gray-200">
                        <dl>
                            ...
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">Prefered position(s)</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{{ Str::title(Str::replace('-', ' ', $player->positions)) }}</dd>
                            </div>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
