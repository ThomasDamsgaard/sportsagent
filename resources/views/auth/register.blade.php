    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex flex-col items-center justify-end my-8 space-y-4">
                ...
                <x-jet-social-button class="bg-gray-600" href="{{ route('google.index') }}" type="button">
                    {{ __('Continue With Google') }}
                </x-jet-social-button>

                <button href="{{ route('google.index') }}" type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
