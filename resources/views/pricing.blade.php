            ...
            <div class="py-24 sm:py-32">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl sm:text-center">
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-600">At OnlineSportsTalent, we're dedicated to empowering you on your journey to professional success..</p>
                    </div>
                    <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                        <div class="p-8 sm:p-10 lg:flex-auto">
                            <h3 class="text-2xl font-bold tracking-tight text-gray-900">Lifetime membership</h3>
                            <p class="mt-6 text-base leading-7 text-gray-600">No hidden fees or gimmicks, just an opportunity to showcase your talent to clubs and colleges worldwide. Whether you dream of excelling in another country or reaching new heights in your home turf, our pricing model is designed with your growth in mind.</p>
                        ...
                        <div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                            <div class="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                                <div class="mx-auto max-w-xs px-8">
                                    <p class="text-base font-semibold text-gray-600">Pay once</p>
                                    ...
                                    <p class="mt-6 text-xs leading-5 text-gray-600">Invoices and receipts available in your personal customer portal</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    <div class="space-y-8 lg:grid lg:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
                        ...
                        <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow  xl:p-8 ">
                            <h3 class="mb-4 text-2xl font-semibold">Athlete</h3>
                        ...
                        <!-- Pricing Card -->
                        <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow  xl:p-8 ">
                            <h3 class="mb-4 text-2xl font-semibold">Team</h3>
